...
RK|download_tarball "https://github.com/openresty/lua-upstream-nginx-module/archive/refs/tags/v${NGINX_LUA_UPSTREAM_MODULE_VERSION}.tar.gz" "${MODULE_DIR}/src/lua-upstream-nginx-module-${NGINX_LUA_UPSTREAM_MODULE_VERSION}.tar.gz"
