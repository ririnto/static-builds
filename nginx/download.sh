...
download_tarball "https://github.com/openresty/lua-resty-core/archive/refs/tags/v${NGINX_LUA_RESTY_CORE_VERSION}.tar.gz" "${MODULE_DIR}/src/lua-resty-core-${NGINX_LUA_RESTY_CORE_VERSION}.tar.gz"
download_tarball "https://github.com/openresty/lua-resty-lrucache/archive/refs/tags/v${NGINX_LUA_RESTY_LRUCACHE_VERSION}.tar.gz" "${MODULE_DIR}/src/lua-resty-lrucache-${NGINX_LUA_RESTY_LRUCACHE_VERSION}.tar.gz"
